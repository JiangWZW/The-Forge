...
bool Visibility_Buffer::Load(ReloadDesc* pReloadDesc)
{
    gFrameCount = 0;
...
void Visibility_Buffer::Unload(ReloadDesc* pReloadDesc)
{
...
void Visibility_Buffer::Update(float deltaTime)
{
    if (!uiIsFocused())
    {
...
bool Visibility_Buffer::addDescriptorSets()
{
    // Clear Buffers
...
void Visibility_Buffer::removeDescriptorSets()
{
...
void Visibility_Buffer::prepareDescriptorSets()
{
    // Clear Buffers
    {
...
bool Visibility_Buffer::addSwapChain()
{
...
void Visibility_Buffer::addRenderTargets()
{
...
void Visibility_Buffer::removeRenderTargets()
{
...
void Visibility_Buffer::addRootSignatures()
{
...
void Visibility_Buffer::removeRootSignatures()
{
...
void Visibility_Buffer::addShaders()
{
...
void Visibility_Buffer::removeShaders()
{
...
void Visibility_Buffer::addPipelines()
{
    /************************************************************************/
...
void Visibility_Buffer::removePipelines()
{
...
void Visibility_Buffer::addTriangleFilteringBuffers(Scene* pScene)
{
    /************************************************************************/
    // Material props
    /************************************************************************/
...
void Visibility_Buffer::removeTriangleFilteringBuffers()
{
    /************************************************************************/
    // Material props
    /************************************************************************/
...
void Visibility_Buffer::updateUniformData(uint32_t currentFrameIdx)
{
    const uint32_t width = mSettings.mWidth;
    const uint32_t height = mSettings.mHeight;
...
void Visibility_Buffer::updateDynamicUIElements()
{
...
void Visibility_Buffer::clearVisibilityBuffer(Cmd* cmd, ProfileToken profileToken, uint32_t frameIdx)
{
...
void Visibility_Buffer::drawShadowMapPass(Cmd* cmd, ProfileToken pGpuProfiler, uint32_t frameIdx)
{
...
void Visibility_Buffer::drawVisibilityBufferPass(Cmd* cmd, ProfileToken pGpuProfiler, uint32_t frameIdx)
{
    UNREF_PARAM(pGpuProfiler);
...
void Visibility_Buffer::blitVisibilityBufferDepthPass(Cmd* cmd, ProfileToken pGpuProfiler, uint32_t view, uint32_t frameIdx,
...
void Visibility_Buffer::drawVisibilityBufferShade(Cmd* cmd, uint32_t frameIdx)
{
...
void Visibility_Buffer::clearLightClusters(Cmd* cmd, uint32_t frameIdx)
{
...
void Visibility_Buffer::computeLightClusters(Cmd* cmd, uint32_t frameIdx)
{
...
void Visibility_Buffer::drawScene(Cmd* cmd, uint32_t frameIdx)
{
...
void Visibility_Buffer::drawSkybox(Cmd* cmd, int frameIdx)
{
...
void Visibility_Buffer::drawGodray(Cmd* cmd, uint32_t frameIdx)
{
...
void Visibility_Buffer::blurGodRay(Cmd* cmd, uint32_t frameIdx)
{
...
void Visibility_Buffer::drawColorconversion(Cmd* cmd)
{
...
void Visibility_Buffer::presentImage(Cmd* const cmd, RenderTarget* pSrc, RenderTarget* pDstCol)
{
...
void Visibility_Buffer::drawGUI(Cmd* cmd, uint32_t frameIdx)
{
    UNREF_PARAM(frameIdx);
